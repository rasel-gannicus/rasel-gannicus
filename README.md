...
- **Frontend:** React.js, Next.js, Redux, RTK Query, Framer Motion, jQuery  
- **Backend:** Laravel, MySQL, REST API, Mongoose  
- CI/CD Pipeline, GitHub Actions  
- Hosting & Deployment: VPS Hosting, cPanel Hosting  
